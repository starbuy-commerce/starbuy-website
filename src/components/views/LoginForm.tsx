                ...
                <div className="md:h-screen bg-white md:float-left">
                    <div className="m-4 md:m-28 md:mt-20">
                        <div>
                            ...
                            <p className="md:flex font-rubik font-bold md:max-w-lg text-sm text-gray-600 mt-16">Faça login com a sua conta. Não tem uma?
                                <p className="text-yellow-500 hover:cursor-pointer md:ml-2" onClick={() => window.location.href = "/register"}> Registre-se</p>
                            </p>
