        ...
        <li>
          ...
          <div className={`${isActive ? "visible" : "invisible"} flex flex-col`}>
            {categories.map((element, index) => {
              return (
                <div className={`${index == categories.length - 1 ? "border-b-[1px] rounded-bl-md rounded-br-md" : ""} p-2 bg-white w-60 border-l-[1px] border-r-[1px] border-gray-700 hover:border-l-4 hover:border-purple-600 hover:bg-yellow-100`} onClick={() => window.location.href = "/category/" + element.value}>
